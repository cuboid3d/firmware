...
#define MSG_DISABLE_STEPPERS                "Sl氓 alle steppere fra"
#define MSG_AUTO_HOME                       "Auto Home" // G28
#define MSG_AUTO_HOME_X                     "Home X"
#define MSG_AUTO_HOME_Y                     "Home Y"
#define MSG_AUTO_HOME_Z                     "Home Z"
#define MSG_LEVEL_BED_HOMING                "Homing XYZ"
#define MSG_LEVEL_BED_WAITING               "Klik n氓r du er klar"
#define MSG_LEVEL_BED_NEXT_POINT            "N忙ste punkt"
#define MSG_LEVEL_BED_DONE                  "Bed level er f忙rdig!"
#define MSG_LEVEL_BED_CANCEL                "Annuller bed level"
#define MSG_SET_HOME_OFFSETS                "S忙t forsk. af home"
#define MSG_HOME_OFFSETS_APPLIED            "Forsk. er nu aktiv"
#define MSG_SET_ORIGIN                      "S忙t origin"
...
#define MSG_COOLDOWN                        "Afk酶l"
#define MSG_SWITCH_PS_ON                    "Sl氓 str酶m til"
#define MSG_SWITCH_PS_OFF                   "Sl氓 str酶m fra"
...
#define MSG_FAN_SPEED                       "Bl忙ser hastighed"
...
#define MSG_USERWAIT                        "Venter p氓 bruger..."
#define MSG_RESUMING                        "Fors忙tter printet"
#define MSG_PRINT_ABORTED                   "Print annulleret"
#define MSG_NO_MOVE                         "Ingen bev忙gelse."
#define MSG_KILLED                          "DR脝BT. "
#define MSG_STOPPED                         "STOPPET. "
#define MSG_CONTROL_RETRACT                 "Tilbagetr忙k mm"
#define MSG_CONTROL_RETRACT_SWAP            "Skift Re.mm"
#define MSG_CONTROL_RETRACTF                "Tilbagetr忙k V"
...
#define MSG_THERMAL_RUNAWAY                 "Temp l酶ber l酶bsk"
...
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   "Fors忙t print"

#if LCD_HEIGHT >= 4
  #define MSG_FILAMENT_CHANGE_INIT_1          "Vent p氓 start"
  #define MSG_FILAMENT_CHANGE_INIT_2          "af filament"
  #define MSG_FILAMENT_CHANGE_INIT_3          "skift"
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        "Vent p氓"
  #define MSG_FILAMENT_CHANGE_UNLOAD_2        "filament udskyd."
  #define MSG_FILAMENT_CHANGE_INSERT_1        "Inds忙t filament"
  #define MSG_FILAMENT_CHANGE_INSERT_2        "og tryk p氓 knap"
  #define MSG_FILAMENT_CHANGE_INSERT_3        "for at forts忙tte..."
  #define MSG_FILAMENT_CHANGE_LOAD_1          "Vent p氓"
  #define MSG_FILAMENT_CHANGE_LOAD_2          "filament indtag"
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1       "Vent p氓"
  #define MSG_FILAMENT_CHANGE_EXTRUDE_2       "filament extrudering"
  #define MSG_FILAMENT_CHANGE_RESUME_1        "Vent p氓 at print"
  #define MSG_FILAMENT_CHANGE_RESUME_2        "forts忙tter"
#else // LCD_HEIGHT < 4
  #define MSG_FILAMENT_CHANGE_INIT_1          "Vent venligst..."
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        "Udskyder..."
  #define MSG_FILAMENT_CHANGE_INSERT_1        "Inds忙t og klik"
  #define MSG_FILAMENT_CHANGE_LOAD_1          "Indtager..."
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1       "Extrudere..."
  #define MSG_FILAMENT_CHANGE_RESUME_1        "Forts忙tter..."
#endif // LCD_HEIGHT < 4
